      ...
      <div className="max-w-md mx-auto">
        <div className="tech-card overflow-hidden">
          ...
          <div className="py-6 bg-gradient-to-r from-tornegors-orange to-orange-600 text-white text-center">
            ...
            <p className="text-white/80 text-sm mt-1">Únete a la comunidad Tornegors</p>
          </div>
          ...
          <div className="p-8">
            <form>
              <div className="mb-5">
                ...
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <User size={18} className="text-tornegors-light/50" />
                  </div>
                  <input 
                    type="text" 
                    className="tech-input w-full pl-10" 
                    placeholder="TorneoMaster2025"
                  />
                </div>
              </div>
              ...
              <div className="mb-5">
                ...
                <p className="text-xs text-tornegors-light/50 mt-1">
              ...
              <div className="mb-6">
                <label className="flex items-center">
                  ...
                  <span className="ml-2 text-sm text-tornegors-light/70">
                    Acepto los <a href="#" className="text-tornegors-orange hover:text-orange-500">Términos de Servicio</a> y la <a href="#" className="text-tornegors-orange hover:text-orange-500">Política de Privacidad</a>
                  </span>
                </label>
              </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-tornegors-light/70 text-sm">
                ¿Ya tienes una cuenta? <Link to="/login" className="text-tornegors-orange hover:text-orange-500 font-medium">Inicia sesión</Link>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-tornegors-light/70 mb-4">O regístrate con</p>
